...
struct display_timings *of_get_display_timings(struct device_node *np)
{
	...
	//add by sampson 
	printk("%s(),%d line the disp->num_timings is %d\n",__func__,__LINE__,disp->num_timings);
	//add over
	...
	printk("%s(),%d line ,the native_mode %d, the disp->num_timings is %d\n",__func__,__LINE__,disp->native_mode,disp->num_timings);
