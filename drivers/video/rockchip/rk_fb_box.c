...
//#define CONFIG_LOGO_LINUX_BMP	//terry 2016-1-20 opengles qt
...
/*
 *  parse disp from resource 
 *  @disp  is the disp_info
 *  @ return value is disp_timing->native_mode
 *  added by sampson 2017/1/10
 * 1280x720 [0]
 * 1920x1080 [1]
 * 3840x2160 [2]
 * 1024x768 [3]
			     ...
			     struct fb_info *info)
{
	...
	printk("win->format = %d stride_32bit_1=%d\n",win->format,stride_32bit_1);//2 2048
	switch (win->format) {
	case YUV422:
	case YUV422_A:
		is_pic_yuv = 1;
