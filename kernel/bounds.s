...
@ -I /home/rk3288-sdk/gpu-rk3288-kernel/arch/arm/include
@ -I arch/arm/include/generated -I include
@ -I /home/rk3288-sdk/gpu-rk3288-kernel/arch/arm/include/uapi
@ -I arch/arm/include/generated/uapi
@ -I /home/rk3288-sdk/gpu-rk3288-kernel/include/uapi
@ -I include/generated/uapi
@ -iprefix /home/rk3288-sdk/prebuilts/gcc/linux-x86/arm/arm-eabi-4.6/bin/../lib/gcc/arm-eabi/4.6.x-google/
@ -D__USES_INITFINI__ -D __KERNEL__ -D __LINUX_ARM_ARCH__=7 -U arm
@ -D KBUILD_STR(s)=#s -D KBUILD_BASENAME=KBUILD_STR(bounds)
@ -D KBUILD_MODNAME=KBUILD_STR(bounds)
@ -isystem /home/rk3288-sdk/prebuilts/gcc/linux-x86/arm/arm-eabi-4.6/bin/../lib/gcc/arm-eabi/4.6.x-google/include
@ -include /home/rk3288-sdk/gpu-rk3288-kernel/include/linux/kconfig.h
@ -MD kernel/.bounds.s.d kernel/bounds.c -mlittle-endian -mabi=aapcs-linux
@ -mno-thumb-interwork -marm -march=armv7-a -mhard-float -mfpu=vfp
